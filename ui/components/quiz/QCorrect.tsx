...
export const QCorrect = ({
  ...
  return (
    <Card className={`w-full max-w-2xl mx-auto ${className}`} style={{ backgroundColor: color }}>
      <CardContent className="space-y-5 p-5">
      <CardTitle>
          Deux réponses sont possibles, sélectionnez les !
          </CardTitle>
        ...
        <Button
          ...
          className="w-full"
        >
          {isSubmitted ? "Vous avez répondu" : `Répondre (${selectedItems.length}/2 selectionné)`}
        </Button>
        {isSubmitted && (
